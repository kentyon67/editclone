                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      {project && (
                        <Link
                          ...
                          className="flex items-center gap-1 text-xs font-medium text-purple-600 bg-purple-50 hover:bg-purple-100 px-2 py-1 rounded-lg transition-colors"
                        >
                          <Layers className="w-3 h-3" />
                          <span className="hidden sm:inline">{t("projectLink")}</span>
                        </Link>
                      )}
                      <Link href={`/${locale}/results/${job.job_id}`}>
